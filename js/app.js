(() => {
    ...
    if (window.innerWidth < 768) document.querySelector(".menu__item-services .menu__item-inner").addEventListener("click", (() => {
        document.querySelector(".menu__item-services .sub-menu__list").classList.toggle("active");
        document.querySelector(".menu__item-services .menu__link").classList.toggle("active");
    }));
    if (document.querySelector(".questions__top")) document.querySelectorAll(".questions__top").forEach((i => i.addEventListener("click", (function() {
        const parentElement = this.closest(".questions__item");
        if (parentElement.classList.contains("active")) document.querySelectorAll(".questions__item").forEach((i => i.classList.remove("active"))); else {
            document.querySelectorAll(".questions__item").forEach((i => i.classList.remove("active")));
